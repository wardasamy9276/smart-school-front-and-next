...
//   // بيانات الواتساب والتليفون المباشر لـ Smart School
...
//             {/* 2. Desktop Actions (Auth & Language Toggle only) */}
//             <div className="hidden md:flex items-center gap-4">
//               {/* زر تغيير اللغة */}
//               <button
//                 onClick={toggleLanguage}
//                 className="px-3 py-1.5 text-xs font-semibold border border-white/40
//                 rounded-lg hover:bg-white/15 transition-colors uppercase tracking-wider"
//               >
...
//             {/* Mobile Menu Button & Language Toggle for Mobile */}
...
//       {/* عناصر التواصل الثابتة أسفل الشاشة (أيقونة الواتساب الرئيسية وأيقونة الفون) مستمرة وثابتة في كل الصفحات */}
...
//           className="w-14 h-14 rounded-full bg-emerald-500 hover:bg-emerald-600 text-white flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 cursor-pointer text-3xl"
//         >
//           <FaWhatsapp />
//         </a>
...
//           className="w-14 h-14 rounded-full bg-[#0e495b] hover:bg-[#135d74] text-white flex items-center justify-center shadow-2xl transition-all duration-300 hover:scale-110 cursor-pointer border border-white/20"
//         >
//           <Phone className="w-6 h-6 fill-white" />
//         </a>
//       </div>
//       {/* 222222222222222222222222222222222222222222222222/ */}
//       {/* عناصر التواصل الثابتة مع دائرة متحركة ومضيئة */}
//       <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3 items-center justify-center">
//         {/* خلفية دائرية متحركة ومضيئة (Pulse & Glow Effect) */}
//         <div className="absolute -inset-3 rounded-full bg-cyan-400/30 blur-md animate-pulse pointer-events-none" />

//         {/* دائرة تدور حول الأيقونات (Rotating Border Effect) */}
