              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                ...
                <div>
                  <label className="mb-2 block text-sm font-semibold text-slate-700">
                    {t("اسم الفصل بالعربية *", "Class Name in Arabic *")}
                  </label>
                ...
                <div>
                  <label className="mb-2 block text-sm font-semibold text-slate-700">
                    {t("اسم الفصل بالإنجليزية *", "Class Name in English *")}
                  </label>
                ...
                <div>
                  <label className="mb-2 block text-sm font-semibold text-slate-700">
                    {t("المعلم بالعربية", "Teacher in Arabic")}
                  </label>
                ...
                <div>
                  <label className="mb-2 block text-sm font-semibold text-slate-700">
                    {t("المعلم بالإنجليزية", "Teacher in English")}
                  </label>
                ...
                <div>
                  <label className="mb-2 block text-sm font-semibold text-slate-700">
                    {t("القاعة بالعربية", "Room in Arabic")}
                  </label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm({
                        ...form,
                        roomAr: e.target.value,
                      })
                    }
                    placeholder="مثال: فصل 101"
                    className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm outline-none focus:border-[#0B192C] focus:bg-white"
                    dir="rtl"
                  />
                </div>
                ...
                <div>
                  <label className="mb-2 block text-sm font-semibold text-slate-700">
                    {t("القاعة بالإنجليزية", "Room in English")}
                  </label>
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="غير نشط">{t("غير نشط", "Inactive")}</option>
                  </select>
                </div>
              </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="w-full max-w-lg rounded-2xl bg-white shadow-2xl">
            ...
            <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
              <div>
                <h2 className="text-xl font-bold text-[#0B192C]">
                  {t("بيانات الفصل", "Class Details")}
                </h2>

                <p className="mt-1 text-sm text-slate-400">
                  {t("التفاصيل الكاملة للفصل", "Complete class information")}
                </p>
              </div>
            ...
            <div className="p-5">
              <div className="mb-6 flex flex-col items-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-[#0B192C] text-white">
                  <School className="h-9 w-9" />
                </div>

                <h3 className="mt-4 text-center text-xl font-bold text-[#0B192C]">
              ...
              <div className="space-y-4">
                ...
                <div className="rounded-xl bg-slate-50 p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm font-semibold text-[#0B192C]">
                        {selectedClass.studentsCount} {t("طالب", "students")}
                      </p>
                    </div>
                ...
                <div className="rounded-xl bg-slate-50 p-4">
                  ...
                  <p className="mt-1 text-sm font-semibold text-[#0B192C]">
                    {selectedClass.capacity} {t("طالب", "students")}
                  </p>
                </div>
